...
import { FaLinkedin, FaGithub, FaUser, FaHome, FaInfoCircle, FaEnvelope } from 'react-icons/fa';
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-8'>
          ...
          <div className='text-center md:text-left'>
            ...
            <div className='grid grid-cols-2 gap-2'>
              ...
              <div className='flex flex-col space-y-3'>
                <Link
                  href='https://www.linkedin.com/in/onkar-dharmadhikari-2b0b7024a/'
                  target='_blank'
                  className='group inline-flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 text-sm font-medium transition-colors duration-200'
                >
               ...
               <Link
                  href='mailto:onkardharmadhikari3@gmail.com'
                  className='group inline-flex items-center gap-2 text-gray-700 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 text-sm font-medium transition-colors duration-200'
                 >
